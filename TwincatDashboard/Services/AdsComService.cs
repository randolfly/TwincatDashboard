...
public class AdsComService : IDisposable
{
    ...
    /// <summary>
    ///     获取所有可行的Symbols 1. 通过SymbolLoader加载所有Symbols 2. 递归遍历所有Symbols(仅获取MAIN和GVL下的Symbols) 3.
    ///     将Symbol转化为SymbolTree，同时执行重复项剔除 4. 将SymbolTree转化为<see cref="List{SymbolInfo}" />，返回
    /// </summary>
    /// <returns>
